...
const registeradmin = catchAsync(async (req, res) => {
  if(req.headers.secretadminkey != process.env.secretadminkey || req.headers.secretadminkey == '' ){
    throw new ApiError(400, "Alarm Triggered! Suspected Activity Detected 🧐reach at security@medzgo.com 😒kyu bhai kya haal he Admin banega woh bhi bina permission? 😂");
  }
  else{
