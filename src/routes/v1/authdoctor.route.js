...
router.post('/forgot-password', auth(),validate(authDoctorValidation.forgotPassword), authDoctorController.forgotPassword);
router.post('/reset-password',auth(), validate(authDoctorValidation.resetPassword), authDoctorController.resetPassword);
...
router.post('/request-otp',auth(), validate(authDoctorValidation.requestOtp), authDoctorController.requestOtp);
router.post('/verify-phone',auth(), validate(authDoctorValidation.verifyPhone), authDoctorController.verifyPhone);
router.post('/resend-otp', auth(), validate(authDoctorValidation.resendOtp), authDoctorController.resendOtp);
router.post('/verifyforgot-otp', auth(), validate(authDoctorValidation.verifyforget), authDoctorController.verifyforgetOtp);
